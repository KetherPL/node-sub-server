...
As of 4th August 2025, the project functionality has been succesfully ported to the Rust programming language (The core / Steam part as the [SC_Sub_Poster library](https://github.com/KetherPL/SC_Sub_Poster)) and merged with our [Internal Services Server](https://github.com/KetherPL/Kether.pl-website-server/tree/rust).
...
*   **REST API Endpoint:** Provides a simple REST endpoint for the L4D2 game server to retrieve SteamID64 (via POST method data) and send Call For Sub requests.
